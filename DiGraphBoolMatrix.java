...
/**
 * DiGraphBoolMatrix es una clase concreta que representa un digrafo usando la
 ...
 * @since 1.6
**/
public class DiGraphBoolMatrix extends DiGraph {
    ...
    /**
     * Crea un DiGraphBoolMatrix vacio.
     * <b>Pre</b>: {@code true;}
     * <b>Post</b>: este DiGraphBoolMatrix está vacio.
     */
    public DiGraphBoolMatrix() {
        this.matrix = null;
        this.numArcs = 0;
        this.numNodes = 0;
    }
    ...
    /**
     * Crea un DiGraphBoolMatrix con n nodos y sin arcos
     * <b>Pre</b>: {@code n} &lt; {@code 0}
     * <b>Post</b>: este DiGraphBoolMatrix tiene {@code n} nodos y ningún arco.
     * @param n el número de nodos con los que se inicializa este DiGraphBoolMatrix.
     */
    public DiGraphBoolMatrix(int n) {
        this();
    ...
    /**
     * Crea un DiGraphBoolMatrix a partir del contenido del archivo.
     * <blockquote>
     * <p><b>Sintaxis</b>:</p>
     ...
     * nodos o arcos.
     * <b>Post</b>: Este DiGraphBoolMatrix se inicializa exitosamente con el DiGraph
     ...
     */
    public DiGraphBoolMatrix(String fileName) throws IOException {
        this(0);
        this.read(fileName);
    }
    
    /**
     * Crea un DiGraphBoolMatrix a partir del DiGraph g
     * <b>Pre</b>: {@code true;}
     * <b>Post</b>: {@code this.equals(g)}
     * 
     * @param g el grafo fuente.
     */
    public DiGraphBoolMatrix(DiGraph g) {
        this(0);
    ...
    /**
     * Agrega un arco a este DiGraphBoolMatrix
     * <b>Pre</b>: Los nodos src y dst deben encontrase en el DiGraphBoolMatrix y no
     * debe existir un arco entre ellos.
     * <b>Post</b>: El DiGraphBoolMatrix contendra un nuevo arco que tendra a src y
     ...
     * encuentren en el DiGraphBoolMatrix
     *
     */
    ...
    /**
     * Permite agregar <i>num</i> nuevos nodos a este DiGraphBoolMatrix.
     * <b>Pre</b>: Debe existir un DiGraphBoolMatrix.
     * <b>Post</b>: El DiGraphBoolMatrix contendrá <i>num</i> nodos nuevos.
     *
    ...
    public void addNodes(int num) {
        if (0 < num) {
            DiGraphBoolMatrix nuevo = new DiGraphBoolMatrix(this.numNodes + num);
            for (int i = 0; i < this.numNodes; i++) {
                for (int j = 0; j < this.numNodes; j++) {
                    if (this.matrix[i][j]) {
     ...
     * adyacencias del DiGraphBoolMatrix, calculada usando el algoritmo de Roy-Warshal
     *
    ...
    public DiGraph alcance() {        
        ...
        DiGraphBoolMatrix nuevo = this.clone();
    ...
    /**
     * Genera una copia de este DiGraphBoolMatrix.
     * <b>Pre</b>: Debe existir un DiGraphBoolMatrix.
     * <b>Post</b>: El DiGraphBoolMatrix tendra una copia exacta.
     *
     * @return una copia de este DiGraphBoolMatrix.
     */
    @Override
    public DiGraphBoolMatrix clone() {
       DiGraphBoolMatrix nuevo = new DiGraphBoolMatrix(this);
       return nuevo;
    }

    /**
     * Elimina un arco de este DiGraphBoolMatrix
     * <b>Pre</b>: Los nodos fuente y destino, es decir nodeIniId y nodeFinId
     * deben existir en el DiGraphBoolMatrix.
     * <b>Post</b>: No existira arco entre los nodos nodeIniId y nodeFinId que
     * pertencen al DiGraphBoolMatrix.
     *
     ...
     * nodeFinId no se encuentren en el DiGraphBoolMatrix.
     */
    ...
    /**
     * Determina si el DiGraph g es igual a este DiGraphBoolMatrix
     * <b>Pre</b>: debe existir un DiGraphBoolMatrix y un Digraph g.
     ...
     * <b>Pre</b>: Los nodos nodoSrc y nodoDst deben pertenecer al DiGraphBoolMatrix
    ...
    /**
     * Retorna el grado de un nodo en este DiGraphBoolMatrix.
     * <b>Pre</b>: El nodo nodeId debe pertencer al DiGraphBoolMatrix
    ...
    /**
     * Retorna el grado interno de un nodo en este DiGraphBoolMatrix
     * <b>Pre</b>: El nodo nodeId debe pertenecer al DiGraphBoolMatrix
     ...
     * <b>Pre</b>: El nodoId debe pertencer al DiGraphBoolMatrix.
    ...
    /**
     * Retorna el numero de arcos en el DiGraphBoolMatrix.
     * <b>Pre</b>: Debe existir un DiGraphBoolMatrix.
     * <b>Post</b>: Se obtendra el numero de arcos que pertencen al
     * DiGraphBoolMatrix.
     *
     * @return numero de arcos que hay en el DiGraphBoolMatrix.
     */
    ...
    /**
     * Retorna el numero de nodos que hay en el DiGraphBoolMatrix.
     * <b>Pre</b>: Debe existir un DiGraphBoolMatrix.
    ...
    /**
     * Retorna el grado externo de un nodo en este DiGraphBoolMatrix.
     * <b>Pre</b>: El nodo nodeId debe pertenecer al DiGraphBoolMatrix.
     ...
     * <b>Pre</b>: El nodoId debe pertenecer al DiGraphBoolMatrix.
     * <b>Post</b>: Se obtendra la lista de nodos que tienen a nodeId como nodo
     * fuente.
     *
    ...
    /**
     * Indica si un arco existe en este DiGraphBoolMatrix.
     * <b>Pre</b>: Los nodos src y dst deben pertenecer al DiGraphBoolMatrix.
    ...
    /**
     * Inicializa este DiGraphBoolMatrix en el DiGraph representado en el contenido
       ...
       if ((new File(fileName)).exists() &&
            ...
            if (tokens.length == 2) {
                if (tokens[0].matches("[0-9]+?") &&
                     ...
                     * DiGraphList y DiGraphBoolMatrix
                     */
     ...
     * <b>Pre</b>: Debe existir un DiGraphBoolMatrix, y sus nodos deben estar
     ...
     * DiGraphBoolMatrix, y seran el nodo fuente y destino respectivamente en caso
    ...
    /**
     * Invierte todos los arcos del DiGraphBoolMatrix.
    ...
    /**
     * Retorna la representacion en String de este DiGraphBoolMatrix.
     * <b>Pre</b>: Debe existir un DiGraphBoolMatrix.
     * <b>Post</b>: Se obtendra la representacion en String del DiGraphBoolMatrix.
     * 
     * @return la representacion en String de este DiGraphBoolMatrix.
     */
    @Override
